...
//public class InsertNewSprite : MonoBehaviour
//{
//    public GameObject newSpritePrefab;
//    public float thumbnailSize = 100;
...
//        // get thumbnail image
//        Sprite myImage = gameObject.GetComponent<SpriteRenderer>().sprite;

//        // create new sprite
//        GameObject newObject = Instantiate(newSpritePrefab, spawnPosition, Quaternion.identity);
//        Sprite newObjectSprite = newObject.GetComponent<SpriteRenderer>().sprite;
//        newObjectSprite = myImage;    // set new gameobject's sprite to downloaded pic

//        // set new gameobject's box collider dimensions proportional to image dimensions
//        float size = 0.01f; // 1 unit in Unity = 100 pixels
//        newObject.GetComponent<BoxCollider>().size = new Vector3(thumbnailSize * size, thumbnailSize * size, 0.2f);
